...
urlpatterns = [
    ...
    path('orders/<int:order_id>/order-item/', CreateOrderItemView.as_view(), name='order-item-create'),
    path('orders/<int:order_id>/order-item/<int:id>/', UpdateDeleteOrderItemView.as_view(), name='order-item-update-delete'),

    path('admin/products', AdminCreateProductView.as_view(), name='admin-product-create'),
